...
- Output-shape notes: toc/children/pagetree emit the visible
  ``[Confluence dynamic content: NAME (params)]`` placeholder (preserving the
  referenced page/params); anchor emits nothing; profile output is name-only.
"""
