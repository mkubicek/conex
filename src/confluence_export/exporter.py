        ...
        *,
        ...
        for stray in page_dir.glob("*.md"):
            ...
            try:
                ...
                pass
        # HTML files are only ever generated by us (debug mode); no realistic
        # use case for the user to keep hand-written .html next to a
        # Confluence export, so we don't need the frontmatter heuristic here.
